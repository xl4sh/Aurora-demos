...
async def main():
    ...
    console.print(f"  Description: Target directory path (optional)")
    default_val = ""
    user_input = console.input(
    ...
    # Meterpreter command execution
    console.print(f"[bold cyan]\n[Meterpreter Executor] Executing: dir[/]")
    confirm_action()
    try:
        metasploit_executor.dir(user_params["DirectoryPath"], user_params["meterpreter_sessionid"])
    except Exception as e:
        console.print(f"[bold red]✗ Command failed: {str(e)}[/]")
        raise
