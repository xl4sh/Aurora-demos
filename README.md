...
This repository contains the emulated cyberattacks constructed by Aurora, an automatic cyberattack emulation system leveraging symbolic planning and large language models (LLMs).
...
Each folder in `attacks/` contains an attach chain, which includes the details of the attack chain and an attack execution script (in Python).
